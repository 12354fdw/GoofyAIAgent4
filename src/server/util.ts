...
export type InstructionPaths =
	"SYSTEM/AGENT.md" | "SYSTEM/WEBSUMMARY.md" | "SYSTEM/SECURITY.md" | "SYSTEM/COMPACTION.md";

export type InstructionInfo =
	{ type: "builtin"; path: InstructionPaths } | { type: "custom"; content: string } | InstructionPaths;
