...
function getOsAgentDescription(platformName: string): string {
    switch (platformName) {
        ...
        default:
            LOGGER.warn(
                "Attempted to give the agent a description of the OS, but the OS identifier is unknown.",
...
export const Tool_ExecuteCommand = tool({
	description: "Executes a command by sending a string to the terminal of the user. Do not use interactive commands, such as text editors, or sudo. " + getOsAgentDescription(os.platform()),
